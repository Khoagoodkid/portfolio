...
export const slides = [
  ...
  },
  {
    ...
    description:
      "A service offering an in-depth exploration of diverse and unique Vietnamese cuisines. This platform provides detailed information about each dish, including its history, ingredients, and cultural significance, offering a comprehensive guide to the rich culinary heritage of Vietnam.",
    images: [
      {
        id: 1,
